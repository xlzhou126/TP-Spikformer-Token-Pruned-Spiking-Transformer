...
parser.add_argument(
    ...
    default="cuda",
    type=str,
    help='Device for single-process training, e.g. "cuda", "cuda:0", "cpu".',
)
parser.add_argument(
...
def main():
    ...
    checkpoint_path = args.initial_checkpoint if args.initial_checkpoint else ""
    model = create_model(
        args.model,
        T=args.time_steps,
    ...
    # macs, params = get_model_complexity_info(model, (3,32,32), as_strings=False, print_per_layer_stat=True)
